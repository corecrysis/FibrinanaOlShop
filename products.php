...
include('koneksi.php');
session_start();
$query= "select * from tb_gallery g  join tb_prod_gallery p on g.g_id_gallery = p.g_id_gallery  join tb_category c on c.p_id_category=g.g_category group by g.g_id_gallery";
...
$query_same = "select * from tb_gallery g  join tb_prod_gallery p on g.g_id_gallery = p.g_id_gallery  join tb_category c on c.p_id_category=g.g_category   group by g.g_id_gallery order by rand() desc limit 4";
				...
				<div class="product-bottom">
					...
					<div class="product-go">
						...
						<div class=" fashion-grid1">
							<h6 class="best2"><a href="sess_as.php?id=<?php echo $rs['g_id_gallery']; ?>" >Lihat Produk Ini  </a></h6>
