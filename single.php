...
$query="select * from tb_gallery g  join tb_prod_gallery p on g.g_id_gallery = p.g_id_gallery  join tb_category c on c.p_id_category=g.g_category where g.g_id_gallery = $ax";
$result = $dbh->query($query)->fetch();
$query1 = "select * from tb_gallery g  join tb_prod_gallery p on g.g_id_gallery = p.g_id_gallery  join tb_category c on c.p_id_category=g.g_category where g.g_id_gallery = $ax";
...
$qx = $result['c_nama_kategori'];
$query_same = "select * from tb_gallery g  join tb_prod_gallery p on g.g_id_gallery = p.g_id_gallery  join tb_category c on c.p_id_category=g.g_category where c.c_nama_kategori = '$qx' and g.g_id_gallery != $ax  group by g.g_id_gallery order by rand() limit 4";
$result_same = $dbh->query($query_same)->fetchAll();
	...
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    ...
			    <li data-thumb="g4j4h_duduk/<?php echo $r1['p_tmp_pict']; ?>">
			        <div class="thumb-image"> <img src="g4j4h_duduk/<?php echo $r1['p_tmp_pict']; ?>" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <?php } ?>
			  </ul>
		</div>
...
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							<h2><?php echo $result['g_nama_produk']; ?></h2>
							<p><?php echo $result['g_deskripsi']; ?></p>
<!--
							<div class="star-on">
								<ul>
...
-->
								...
								<label  class="add-to item_price">Kategori : <?php echo $result['c_nama_kategori']; ?></label>
...
<!--seller-->
				<div class="product-bottom">
						<h3 class="cate">Produk Terkini</h3>
